...
| 8x8 Baking Pan                                   | -        | -    |
** Steps
1) [&:00:02:00] Chop [#: almonds-id | almonds] roughly. Put them in a bowl.
...
2) [&: 00:04:00] When hot, add olive oil, onion, bell pepper and garlic. Saute for 4-5 minutes, stirring frequently.
...
5) [&: 00:15:00] Add chickpeas and olives. Reduce heaet to medium-low for 15-20 minutes.
** Content
:PROPERTIES:
:type: big-quote
:END:
...
1) Make the marinade: combine Olive oil, seasami oil, hot sauce, thyme, paprika,
   and salt. Set aside.
2) [&: 00:30:00] Add marinade and tofu to a container and marinate for 30 minutes, up to a day
3) Preheat the oven to 400ºF (200ºC).
4) [&: 00:20:00] Cut sweet potato into cubes. Slice the onion, dice garlic. Put it all on a
...
6) [&: 00:10:00] Transfer chickpeas to skilled and cook on medium heat for 10 minutes. Set aside.
...
3) [&: 00:03:00] Add brows and kimchi juice and bring to a simmer. Cook until slightly reduce,
   about 3 minutes
4) Boil noodles according to package directions.
5) [&: 00:02:00] Using tongs, transfer noodles to the skiller and add the remaining 3 tbsp of
...
:END:
** Ingredients
| Ingredient                | Quantity | Unit        | Group           | Id                |
|---------------------------+----------+-------------+-----------------+-------------------|
| Tofu (firm)               |        1 | package     | tofu            | tofu              |
| Olive oil                 |       -- | --          | tofu            | olive_oil         |
| salt                      |       -- | pinch       | tofu            | salt              |
| Shredded Coconut          |      1/4 | cups        | coconut rice    | shredded_coconut  |
| Brown rice                |        1 | cups        | coconut rice    | brown_rice        |
| Coconut milk              |        1 | can (400ml) | coconut rice    | coconut_milk      |
| Brown Sugar               |        2 | tsp         | coconut rice    | brown_sugar       |
| Coconut oil               |        1 | tsp         | coconut rice    | coconut_oil       |
| Pineapple (diced)         |    1+1/2 | cups        | pineapple salsa | pineapple         |
| Red onion (diced)         |      1/4 | cups        | pineapple salsa | red_onion         |
| Jalapenos (seeded, diced) |        1 | pepper      | pineapple salsa | jalapenos         |
| Garlic (minced)           |        1 | clove       | pineapple salsa | garlic            |
| Bell pepper               |        1 | --          | pineapple salsa | bell_pepper       |
| Fresh lime juice          |        3 | tbsp        | pineapple salsa | lime_juice        |
| Red pepper flakes         |        1 | dash        | pineapple salsa | red_pepper_flakes |
** Steps
1) [&:00:20:00] Press the tofu for about 20 minutes (put something heavy on it.)
