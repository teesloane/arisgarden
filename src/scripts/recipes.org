...
4) [&: 00:20:00] Cut [#: potato-sweet | sweet potato] into cubes. Slice the [#: onion | onion], dice [#: garlic | garlic]. Put it all on a baking sheet. Drizzel with oil, season with salt and pepper. Bake for 20-25 min.
...
4) [&: Saute | 13:02:12] Add [#: wine | wine]. Saute for 2-4 minutes.
...
6) [&:00:30:00] Put tofu in the oven for 25 to 30 minutes until golden on the edges.
