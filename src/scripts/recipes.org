...
** Ingredients
:PROPERTIES:
:ID:       20134CB2-E274-492E-844C-519D626F58A9
:END:
| Ingredient          | Quantity | Unit  | Id                | Group    | Prep    |
|---------------------+----------+-------+-------------------+----------+---------|
...
3) Put [#: egg | cubed eggplant] on baking sheet in a single layer and coat with olive oil. Sprinkle with salt. Set aside.
...
2) [&: Cook onion | 00:03:00] Cook white and pale-green parts of green onions (save the green
   ends) and the [#: gar | garlic] and [#: ging | ginger]. Stir often, about 3 minutes.
3) Add [#: vegbro | broth]. Whisk in [#: gochu | gochujang] and [#: soy | soy sauce].
...
* Zucchini Noodle Medley
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-02-18]
:ease_of_making:  4/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegan
:name:            Zucchini Noodle Medley
:original_recipe:
:rating:          3/5
:serves:          4
:slug:            zucchini-noodle-medley
:tags:            []
:time:            00:45:00
:END:
** Ingredients
...
|----------------+----------+------------+-------+------------+-------|
| Olive oil      |        1 | tbsp       | oo    |            |       |
| Yellow onion   |        2 |            | yo    | diced      |       |
| Garlic cloves  |        4 |            | gar   | minced     |       |
| Carrots        |        2 |            | car   | diced      |       |
| Celery         |        3 | stalks     | cel   | diced      |       |
| Chickpeas      |        2 | cups       | cp    |            |       |
| Diced tomatoes |        2 | cups       | dt    |            |       |
| Coconut milk   |      3/4 | cups       | cm    |            |       |
| Tomato paste   |      1/4 | cups       | tp    |            |       |
| Water          |        2 | cups       | water |            |       |
| Basil leaves   |      1/4 | cups       | bl    | chopped    |       |
| Spinach leaves |        2 | cups       | sl    | packed     |       |
| Zucchini       |        2 | large      | zuc   | spiralized |       |
| Spiralizer     |          | (optional) |       |            |       |
** Steps
1) Heat oil in a large pan on medium heat.
2) [&: Sauté | 00:03:00] Add [#: yo | onion], [#: gar | garlic], [#: car | carrots], and [#: cel | celery]. Sauté for 3-4 minutes.
3) [&: Simmer everything | 00:10:00] Add [#: cp | chickpeas], [#: dt | diced tomatoes ], [#: cm | coconut milk], [#: tp | tomato paste] and [#: water | water]. Bring to a boil and simmer for about 8-10 minutes or until thickened.
4) Spiralize zucchini (if you have a spiralizer), otherwise, slice into long matchsticks.
5) Stir in basil leaves and spinach until wilted. Season with salt.
6) [&: Add zucchini | 00:03:00] Add in zucchini for 2-3 minutes.
** Content
:PROPERTIES:
:type: haiku
:END:
- This came out a little bland.
- In retrospect, the recipe had no spices!
- Maybe some cumin would have been interesting?
* Spaghetti Squash Burrito Bowl                                                 :main:five_stars:
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-02-21 Fri]
:ease_of_making:  5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:            Spaghetti Squash Burrito Bowl
:original_recipe: https://cookieandkate.com/spaghetti-squash-burrito-bowl-recipe/
:rating:          5/5
:serves:          4
:slug:            spaghetti-squash-burrito-bowl
:tags:            []
:time:            00:45:00
:END:
** Ingredients
| Ingredient       | Quantity | Unit | Id     | Prep                  | Group               |
|------------------+----------+------+--------+-----------------------+---------------------|
| Spaghetti squash |        2 |      | ss     | halved, seeds removed | Spaghetti Squash    |
| Olive oil        |        2 | tbsp | oo     |                       | Spaghetti Squash    |
| Salt and Pepper  |          |      | sp     |                       | Spaghetti Squash    |
| Purple cabbage   |        2 | cups | pc     | sliced, 2 inches long | Filling             |
| Black beans      |       15 | oz   | bb     | rinsed, drained       | Filling             |
| Bell pepper      |        1 |      | bp     | chopped               | Filling             |
| Green onions     |      1/3 | cups | go     | chopped               | Filling             |
| Cilantro         |      1/3 | cups | cil    | chopped               | Filling             |
| Olive oil        |        1 | tsp  | oo2    |                       | Filling             |
| Lime juice       |        3 | tbsp | lime   | squeezed              | Filling             |
| Salt             |      1/4 | tsp  | salt2  |                       | Filling             |
| Salsa Verde      |      3/4 | cups | verde  |                       | Avocado Salsa Verde |
| Avocado          |        1 |      | avo    | diced                 | Avocado Salsa Verde |
| Cilantro         |      1/3 | cups | cil2   | de-stemmed            | Avocado Salsa Verde |
| Lime juice       |        1 | tbsp | lime2  | squeezed              | Avocado Salsa Verde |
| Garlic           |        1 |      | garlic | chopped               | Avocado Salsa Verde |
| Feta             |      1/3 | cups | feta   | crumbled              | Topping (optional)  |
| Pepitas          |      1/4 | cups | pep    |                       | Topping (optional)  |
| Blender          |          |      |        |                       |                     |
** Steps
1) Prehead oven to 400F.
2) Prepare the squash. Halve and de-seed. Drizzel and rub inside with [#: oo | olive oil].
3) [&: Roast squash | 00:40:00] Put squashes on parchment paper and onto an oven
   sheet. Bake for 40 minutes or until easily pierced with a fork.
4) Assemble the Filling while squashes are in the oven. In a medium bowl,
   combine [#: pc | cabbage], [#: bb | black beans], [#: bp | bell pepper],  [#:
   go | green onion], [#: cil | cilantro], [#: lime | lime juice], [#: oo2 |
   olive oil] and salt. Toss to combine and set aside.
5) Make the salsa verde: combine [#: avo | avocado], [#: verde | salsa verde],
   [#: cil2 | cilantro], [#: lime2 | lime juice] and [#: garlic | garlic] into a
   blender. Blend until smooth.
6) Assemble: use a fork to separate and fluff the inside of the spaghetti
   squash. Divide the filling into each squash and then top with the avocado
   salsa verde. Top with feta, salt and pepper and pepitas.
** Content
:PROPERTIES:
:type: haiku
:END:
- The squash bowl is fine
- A bowl to have just one time
- You cannot keep it.
* Beet Burgers with Cucumber                                                    :main:
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-02-25 Tue]
:ease_of_making:  3.5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:            Yogurt Cucumber Beet Burger
:original_recipe:
:rating:          ?/5
:serves:          4
:slug:            beet-burgers
...
| Ingredient       | Quantity | Unit    | Id    | Prep         | Group   |
|------------------+----------+---------+-------+--------------+---------|
| Grater           |          |         |       | grated       | Burger  |
| Beets            |        2 | (small) | be    | grated       | Burger  |
| Carrots          |        2 |         | car   | grated       | Burger  |
| Potatoes         |        2 | (small) | pot   | grated       | Burger  |
| Garlic           |        4 | cloves  | gar   | minced       | Burger  |
| Parsley          |        1 | bunch   | par   | finely diced | Burger  |
| Tahini           |        2 | tbsp    | tah   |              | Burger  |
| Chia seeds       |        2 | tbsp    | chia  |              | Burger  |
| Hemp seeds       |        2 | tbsp    | hemp  |              | Burger  |
| Ground coriander |        2 | tsp     | cori  |              | Burger  |
| Cumin            |        2 | tsp     | cumin |              | Burger  |
| Almond flour     |      2/3 | cups    | af    |              | Burger  |
| Salt/Pepper      |          |         | sp    |              | Burger  |
| Cucumber         |        2 | (small) | cuc   | spiralized   | Topping |
| Coconut Yogurt   |      100 | grams   | yog   |              | Topping |
|------------------+----------+---------+-------+--------------+---------|
** Steps
1) Preheat oven to 350F and line a baking tray with baking paper.
2) Grate the [#: be | beets], [#: pot | potatoes] and [#: car | carrots] into a
   large bowl.
3) Add to bowl: [#: par | parsley], [#: gar | garlic], [#: tah | tahini], [#:
   chia | chia seeds], [#: hemp | hemp seeds], [#: cumin | cumin], [#: cori |
   coriander] and [#: af | almond flour]. Season with salt and pepper.
4) Use your hands to mix the contents of the bowl until it forms a  wet dough.
   Shape mixture into ten to twelve burger patties and place on the lined tray.
5) [&: Bake patties | 00:15:00] Bake in the oven for 15 minutes, remove and flip.
6) Repeat the previous step.
7) Top patties with spiralized [#: cuc | cucumber] and [#: yog | coconut yoghurt].

** Content
:PROPERTIES:
:type: big-quote
:END:
- "BE CAREFUL WITH THE GRATER."
* Potato Stuffed Peppers                                                        :main:
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-02-27]
:ease_of_making:  5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:            Sweet Potato Stuffed Peppers
:original_recipe:
:rating:          5/5
:serves:          4
:slug:            sweet-potato-stuffed-peppers
:tags:            []
:time:            01:00:00
:END:
** Ingredients
| Ingredient           | Quantity | Unit    | Id   | Prep         | Group |
|----------------------+----------+---------+------+--------------+-------|
| Bell peppers         |        4 |         | pep  | Tops removed |       |
| Canned brown lentils |        1 |         | bl   |              |       |
| Sweet potato         |        1 | (large) | sp   | Shredded     |       |
| Feta                 |      1/4 | cups    | feta | Crumbled     |       |
| Red onion            |      1/2 | cups    | ro   | Finely diced |       |
| Spinach              |        1 | cups    | sp   |              |       |
| Garlic               |        4 | cloves  | gar  | crushed      |       |
| Oregano              |        2 | tsp     | oreg | dried        |       |
| Olive oil            |        1 | tbsp    | oil  |              |       |

** Steps
1) Preheat the oven to 350F. Line an oven tray with baking paper.
2) Shred the [#: sp | potato] with a cheese grater.
3) Remove the tops of the bell peppers and deseed them. Place them on the baking sheet.
4) [&: Step 3 | 00:03:00] Heat a pan on medium heat and sauté the [#: ro | onion ] and [#: sp |
   spinach] and [#: gar | garlic] for a couple minutes.
5) [&: Step 5 | 00:07:00] Add the sweet potato, [#: oreg | oregano] and [#: bl | brown lentils] and
   cook for about 7 or 8 minutes. Mix the feta in while you cook.
6) Divide contents of frying pan into the peppers, filling them evenly.
7) Place the top back on the peppers if possible and drizzle with olive oil.
8) [&: 7. Bake peppers | 00:40:00] Bake the stuffed peppers in the oven for 40-45 minutes or until it has darkened on the outside.
...
* Date Oat Globes (/Dato Globes/)                                               :sweet:
:PROPERTIES:
:belongs_to:      sweet
:date_made:       [2020-02-29]
:ease_of_making:  5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegan
:name:            Date Oat Globes
:original_recipe:
:rating:          5/5
:serves:          10-12
:slug:            dato-globes
:tags:            ["snack", "granola", "oven-free" "Dato"]
:time:            00:25:00
:END:
** Ingredients
| Ingredient       | Quantity | Unit | Id   | Prep | Group |
...
| Blender          |          |      |      |      |       |
| Dates            | 1        | cups | da   |      |       |
| Almond butter    | 1/3      | cups | ab   |      |       |
| Rolled oats      | 1/3      | cups | oats |      |       |
| Shredded coconut | 1/4      | cups | sc   |      |       |
| Rice Malt Syrup  | 4        | tsp  | rms  |      |       |
| Cinnamon         | 1        | tsp  | cin  |      |       |
** Steps
1. [&: Soften Dates | 00:05:00] Soften the [#: da | dates] in warm water for a few minutes and then drain.
2. Blend the dates.
3. In a large bowl, add the blended dates, [#: ab | almond butter], [#: oats | oats], [#: sc | coconut], [#:
   rms | rice malt syrup], and [#: cin | cinnamon] and mix by hand until combined.
4. Roll the mixture into bowls, place in a container. Keep in freezer.
** Content
:PROPERTIES:
:type: whisper
:END:
- Date. Oat. Globes. DATO GLOBES.
* Zucchini Chickpea Salad                                                       :salad:
:PROPERTIES:
:belongs_to:      salad
:date_made:       [2020-03-01]
:ease_of_making:  5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
...
:rating:          4/5
:serves:          4
:slug:            zuc-chickpea-salad
:tags:            ["zucchini", "salad", "lunch"]
:time:            00:45:00
:END:
** Ingredients
| Ingredient       | Quantity | Unit  | Id  | Prep                 | Group    |
|------------------+----------+-------+-----+----------------------+----------|
| Chickpeas        |      400 | grams | cp  | Drained and Dried    | Salad    |
| Zucchini         |        6 | cups  | zuc | Peeled or Spiralized | Salad    |
| Cucumber         |        2 | cups  | cuc | Peeled or Spiralized | Salad    |
| Goat cheese      |      1/2 | cups  | gc  | Crumbled             | Salad    |
| Red oinion       |      2/3 | cups  | ro  | Sliced               | Salad    |
| Cherry tomatoes  |      1/2 | cups  | ct  | Chopped              | Salad    |
| Olive oil        |        1 | tbsp  | oo1 |                      | Salad    |
| Paprika          |        2 | tsp   | pap |                      | Salad    |
| Salt             |        1 | pinch | sal |                      | Salad    |
| Grain Mustard    |        2 | tsp   | mu  |                      | Dressing |
| Olive oil        |        1 | tbsp  | oo2 |                      | Dressing |
| Balsamic Vinegar |        2 | tbsp  | bv  |                      | Dressing |
** Steps
1) Pre-heat oven to 350F degrees. Line a baking tray with baking paper.
2) Dry [#: cp | chickpeas] with a towel. Once dry, transfer the chickpeas to a
   baking tray. Drizzle [#: oo2 | olive oil ] and add [#: pap | paprika] and [#:
   sal | salt].
3) [&: Bake Chickpeas | 00:15:00] Bake the chickpeas for 15-20 minutes or until golden brown. When done, remove from the oven and allow to cool.
4) Spiralize zucchini and cucumber.
5) Add the [#: zuc | zucchini], [#: cuc | cucumber], [#: ro | onion] and [#: ct | cherry tomato] into a bowl.
6) Add the chickpeas and [#: gc | goat cheese ] to the bowl.
7) Make the dressing: combine [#: mu | grain mustard], [#: oo2 | olive oil] and
   [#: bv | balsamic vinegar] into a jar. Stir well to combine.
8) Add dressing to salad and serve.
** Content
:PROPERTIES:
:type: whisper
:END:
- This cucumber thinks it's a zucchini. Here look. Just wait for it. See! Did
  you see it?
* Cauliflower Potato Balls
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-03-15 Sun]
:ease_of_making:  3.5/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegan
:name:            Cauliflower Potato Balls
:original_recipe:
:rating:          4/5
:serves:          4
:slug:            cauliflower-potato-balls
:tags:            ["curry"]
:time:            01:00:00
:END:
** Ingredients
| Ingredient      | Quantity | Unit   | Id     | Prep           | Group                    |
|-----------------+----------+--------+--------+----------------+--------------------------|
| Cauliflower     |        1 | head   | cau    | finely chopped | Cauliflower Potato Balls |
| Potatoes        |        3 | cups   | pot    | chopped        | Cauliflower Potato Balls |
| Corn starch     |        4 | tsp    | cs     |                | Cauliflower Potato Balls |
| Baking soda     |        1 | tsp    | bs     |                | Cauliflower Potato Balls |
| Dried coriander |        1 | tsp    | dc     |                | Cauliflower Potato Balls |
| Cumin           |        2 | tsp    | cumin  |                | Cauliflower Potato Balls |
| Olive oil       |        1 | tbsp   | oil    |                | Cauliflower Potato Balls |
| Salt and Pepper |       -- |        | sp     |                | Cauliflower Potato Balls |
| Coconut milk    |      300 | ml     | com    |                | Creamy Curry Sauce       |
| Tomatoes        |        4 | cups   | tom    | diced          | Creamy Curry Sauce       |
| Water           |      1/2 | cups   | wa     |                | Creamy Curry Sauce       |
| Brown onion     |      1/2 |        | bo     | diced          | Creamy Curry Sauce       |
| Cashews         |        3 | tbsp   | cash   |                | Creamy Curry Sauce       |
| Olive oil       |          |        |        |                | Creamy Curry Sauce       |
| Garlic          |        1 | cloves | gar    | diced          | Creamy Curry Sauce       |
| Dried coriander |        1 | tsp    | dc2    |                | Creamy Curry Sauce       |
| Cumin           |        2 | tsp    | cumin2 |                | Creamy Curry Sauce       |
| Turmeric        |        1 | tsp    | tur    |                | Creamy Curry Sauce       |
| Dijon mustard   |        2 | tsp    | dij    |                | Creamy Curry Sauce       |
| Red chilies     |        2 | tsp    | redch  | chopped        | Creamy Curry Sauce       |
| Salt and Pepper |          |        |        |                | Creamy Curry Sauce       |
** Steps
 1. Preheat the oven to 350 degrees. Prepare a baking sheet (or two) with parchment paper.
 2. Bring a large pot of water to a boil and cook the [#: pot | potatoes] for 10 minutes, or until the potato is soft.
 3. Drain the potatoes and place them in a large bowl. Mash the potato, and let it cool for a bit.
 4. After a few minutes, mix in the [#: cau | cauliflower], [#: cs | corn starch], [#: bs | baking soda], [#: dc | coriander], and [#: cumin | cumin]. Season with salt and pepper to taste.
 5. Once combined, use your hands to roll the mixture into 20 - 24 balls.
 6. Lightly coat the outside of each ball with olive oil and add it to the baking sheet.
 7. Cook the balls for 30 minutes, turning them over half way through.
 8. While the balls cook, prepare the curry cream sauce: heat olive oil in a sauce pan then add the [#: bo | onion], [#: gar | garlic], [#: redch | chilies], [#: dij | mustard], [#: cumin2 | cumin] and [#: tur |  turmeric]. Let cook, stirring occasionally, for 4-5 minutes.
 9. Add the [#: tom | tomatoes], [#: wa | water], [#: com | coconut milk], [#: dc2 | coriander], and a bit of salt and pepper. Cook at a simmer for 10 minutes.
 10. Add in the [#: cash | cashews] and cook for 5 more minutes.
 11. When the Cauliflower-Potato balls come out of the oven, serve in a bowl or rimmed plate and pour the curry sauce over top.
** Content
:PROPERTIES:
:type: whisper
:END:
...
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-03-24 Tue]
:ease_of_making:  3/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:            Halloumi Pomegranate Salad
:original_recipe:
:rating:          4/5
:serves:          2
:slug:            halloumi-pomegranate-salad
:tags:            ["salad", "light", "salty"]
:time:            01:00:00
:END:
** Ingredients
| Ingredient         | Quantity | Unit  | Id  | Prep              | Group    |
|--------------------+----------+-------+-----+-------------------+----------|
| Halloumi Cheese    |      150 | grams | hal | sliced            | Salad    |
| Lettuce            |      120 | grams |     | washed / shredded | Salad    |
| Cherry tomatoes    |        1 | cups  | ct  | chopped           | Salad    |
| Red onions         |      1/4 | cups  | ro  | sliced            | Salad    |
| Pomegranate        |      1/3 | cups  | pom |                   | Salad    |
| Almonds            |      1/4 | cups  | alm | chopped           | Salad    |
| Olive oil          |        1 | tbsp  | oil |                   | Dressing |
| Balsamic vinegar   |        3 | tbsp  | vin |                   | Dressing |
| Wholegrain mustard |        1 | tsp   | mu  |                   | Dressing |
** Steps
1. Prepare the pomegranate: fill a large bowl with water and loosen seeds in the
   water. This saves making a mess, seeds you don't get will sink to the bottom
   and the shell will float in the water.
2. Mise en place the [#: ct |  cherry tomatoes ], the [#: ro | red onion] and
   the [#: alm | almonds]. Slice the halloumi.
3. Heat up a pan on medium heat. Add the halloumi to the pan, for about 3 or 4
   minutes a side until golden.
4. While the cheese fries, combine tomatoes, almonds, lettuce, and red onion in
   a large bowl.
5. Prepare the dressing by mixing the [#: oil | olive oil], [#: vin | balsamic]
   and [#: mu | mustard] in a jar and stir to combine.
6. Mix the cheese into the salad and top with dressing and pomegranates.
** Content
:PROPERTIES:
:type: haiku
:END:
- "What now?" muttered Morand under his breath. He glanced at Garibaldo in
  the corner. He was hiding something. Morand advanced on him, cursing. He had
  the halloumi, and he knew it. It wasn't likely he would get it back.
- "Borrowingly Yours" - Pg 103.
* Spice and Rice Tofu Salad
:PROPERTIES:
:belongs_to:      salad
:date_made:       [2020-04-01 Wed]
:ease_of_making:  4/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:            Spice and Rice Tofu Salad
:original_recipe:
:rating:          3.5/5
:serves:          4
:slug:            spice-and-rice-tofu-salad
:tags:            ["salad", "light", "salty"]
:time:            01:00:00
:END:
** Ingredients
| Ingredient        | Quantity | Unit    | Id   | Prep    | Group    |
|-------------------+----------+---------+------+---------+----------|
| Firm tofu         |        1 | package | tofu | chopped | Salad    |
| Brown rice        |        1 | cups    | rice |         | Salad    |
| Kale              |      1/2 | cups    | kale | chopped | Salad    |
| Cabbage           |        1 | cups    | cab  | chopped | Salad    |
| Avocado           |        1 |         | avo  | chopped | Salad    |
| Garlic            |        2 |         | gar  | minched | Salad    |
| Cumin             |        2 | tsp     | cu   |         | Salad    |
| Dried coriander   |        2 | tsp     | cor  |         | Salad    |
| Turmeric          |        1 | tsp     | tur  |         | Salad    |
| Salt and Pepper   |    Pinch |         | sp   |         | Salad    |
| Olive oil         |        2 | tbsp    | oil  |         | Dressing |
| Balasamic vinegar |        4 | tbsp    | vin  |         | Dressing |
** Steps
1. [&: Prepare rice | 00:30:00] Prepare the rice: put rice in a pot with 2 cups of water and bring to a boil. Once boiling, lower temperature to low-medium and cook for about 25 minutes or until water is absorbed.
2. While rice is cooking, prepare [#: tofu | tofu]. Mix [#: cu | cumin], [#: cor | coriander], [#: tur | turmeric] and [#: sp | salt and pepper] in a bowl.
3. [&: Heat tofu on all sides | 00:08:00] Heat a pan with a drizzle of olive oil. Once hot, add the tofu, and sprinkle the spices on the tofu. Cook the tofu for about 4 minutes, then flip and repeat until tofu is golden brown.
4. While tofu is cooking, combine [#: kale | kale], [#: cab | cabbage], [#: avo | avocado] in a bowl. Once the rice is cooked, and it to the bowl.
5. Mix [#: oil | olive oil] and [#: vin | balsamic vinegar] in a jar and then drizzle over the bowl.
** Content
:PROPERTIES:
:type: big-quote
:END:
...
| Ingredient      | Quantity | Unit   | Id    | Prep              | Group |
|-----------------+----------+--------+-------+-------------------+-------|
| Quinoa (cooked) |        2 | cups   | qu    |                   |       |
| Sweet potato    |        2 | cups   | sp    | shredded          |       |
| Olive oil       |        2 | tbsp   | oil   |                   |       |
| Red onion       |      1/2 | cups   | ro    | diced             |       |
| Garlic          |        4 | cloves | gar   | minced            |       |
| Salt            |        1 | pinch  | sal   |                   |       |
| Spinach         |        2 | cup    | spin  | copped            |       |
| Eggs            |        3 |        | egg   | whisked           |       |
| Curry powder    |        1 | tsp    | cp    |                   |       |
| Flour           |      1/2 | cups   | flour |                   |       |
| Jalapeno        |        1 |        | jal   | sliced or pickled |       |
| Yogurt          |        1 | cups   | yog   |                   |       |
| Cucumber        |        1 | cups   | cuc   | sliced            |       |
** Steps
1. Make enough quinoa so that you have 2 cups of cooked quinoa. This usually
   equates to about 3/4 cups dry quinoa.
2. Shred sweet potato with a grater or food processor.
3. [&: Sauté | 00:05:00 ] Heat a large pot or skillet. Once hot, add [#: oil | olive oil] and heat. Then add [#: ro | onion], [#: sp | shredded sweet potato], [#: gar | garlic], and [#: sal | salt]. Sauté for 4-5 minutes.
4. Add chopped spinach to skillet until it wilts.
5. In a large mixing bowl, crack three eggs and whisk. Set aside.
6. In the large mixing bowl, add the sautéed vegetables, the [#: quinoa | qu], a pinch of salt, and [#: cp | curry powder] . Mix until combined.
7. It's patty time! Make patties about the size of your hand until there is no mixture left.
8. [&: Fry fritters | 00:08:00 ] Heat a skillet until hot. Add oil, and start to fry your fritters. Fry them for about 4 minutes on each side.
9. Optionally, heat up an oven to keep fritters warm while others cook. This can add a nice crisp to them.
10. Cut up cucumber and dish [#: yog | yogurt] into a bowl. Slice avocado. Plate avocado and cucumber, alongside fritters with a dollop of yogurt. Optionally, add rings of [#: jal | jalapeno].
** Content
:PROPERTIES:
:type: big-quote
:END:
- It's all about the toppings. And the base. It's all about the everything.

* Black Lentils and Sriracha Veggies
:PROPERTIES:
:belongs_to:      main
:date_made:       [2020-05-07 Thu]
:ease_of_making:  4/5
:imgs:            ["1.jpg", "2.jpg", "3.jpg"]
:meal_type:       vegetarian
:name:  Black Lentils and Sriracha Veggies
:original_recipe: https://www.bonappetit.com/recipe/black-lentil-and-harissa-roasted-veggie-bowl
:rating:          5/5
:serves:          4
:slug:            black-lentil-spicey-veggies
:tags:            []
:time:            00:45:00
:END:
** Ingredients
| Ingredient       | Quantity | Unit | Id   | Prep    | Group              |
|------------------+----------+------+------+---------+--------------------|
| Salt             | 1/2      | tsp  | sel  |         | Roasted vegetables |
| Coriander        | 1/2      | tsp  | gc   |         | Roasted vegetables |
| Olive oil        | 2        | tbsp | oil  |         | Roasted vegetables |
| Sriracha         | 1        | tbsp | sri  |         | Roasted vegetables |
| Sweet potatoes   | 2        |      | sp   | Chopped | Roasted vegetables |
| Cherry tomatoes  | 1        | pint | ct   | Halved  | Roasted vegetables |
| Black lentils    | 1        | cups | bl   |         | Black Lentils      |
| Red wine vinegar | 1+1/2    | tbsp | rwv  |         | Black Lentils      |
| Honey            | 1/2      | tbsp | hon  |         | Black Lentils      |
| Sriracha         | 1        | tbsp | sri2 |         | Black Lentils      |
| Oil              | 1+1/2    | tbsp | oil2 |         | Black Lentils      |
| Cilantro         | 1/4      | cups | cil  | Chopped | Black Lentils      |
** Steps
 1. Preheat the oven to 425.
 2. [&: Cook lentils | 00:25:00] While the oven heats up, bring a pot of water to a boil and add in the [#: bl | lentils]. Lower the heat to a simmer and cook for 25-30 minutes. When the timers up, drain and transfer to a large bowl.
 3. On a rimmed baking sheet, lay out the [#: sp | sweet potato] and [#: ct | cherry tomatoes].
 4. In a small bowl, whisk together the [#: gc | coriander], [#: sel | salt], [#: oil | olive oil] and [#: sri | sriracha]. Pour the mixture over the vegetables (save the bowl).
 5. [&: Roast vegetables | 00:25:00] Roast for 25-30 minutes, until the sweet potato is tender. Toss the vegetables about half way through.
 6. In the saved sriracha bowl, whisk in the [#: rwv | vinegar], [#: hon | honey], [#: sri2 | sriracha] and [#: oil2 | olive oil], season with salt and pepper to taste.
 7. Pour about half of the dressing straight on the lentils and mix in.
 8. To serve add the roasted sweet potato and tomatoes on top of a bowl of lentils. Top with more vinaigrette and more cilantro/parsley.
** Content
:PROPERTIES:
:type: haiku
:END:
- Spicey Spicey Lentil.
* Challah Bread
:PROPERTIES:
:belongs_to:      sweet
:date_made:       [2020-05-07 Thu]
...
:meal_type:       vegetarian
:name:            Challah Bread
:original_recipe: https://en.wikipedia.org/wiki/Joy_of_Cooking
:rating:          4/5
:serves:          2 Loaves
:slug:            challah-bread
:tags:            ["bread", "baking"]
...
| Flour         |        6 | cups | flour |                 |       |
| Yeast         |        4 | tsp  | ye    |                 |       |
| Eggs          |        3 |      | eggs  | slightly beaten |       |
| Egg Yolk      |        1 |      |       |                 |       |
| Vegetable oil |      1/4 | cups | voil  |                 |       |
| Poppy seeds   |        2 | tbsp |       | optional        |       |
| Baking sheets |        2 |      |       |                 |       |

** Steps
1. Combine [#: ye | yeast] with 1 tsp of sugar and 1/4 cup of warm water.
2. In a large bowl, add [#: flour | flour] and 1 tbsp of salt.
3. Make a "well" in the flour and pour in the yeast mixture. Combine.
4. Add to the mixture: 2 cups of warm water, [#: eggs | slightly beaten eggs], [#: voil | vegetable oil], 3 tbsp of sugar.
5. Beat well until a ball of dough is formed. It will be pretty oily and damp, but don't stress.
6. Put dough on well-floured board and knead for about 10 minutes, until smooth and elastic.
7. [&: Let dough rise | 01:00:00] Place in a greased bowl, cover and allow to rise until doubled in size (about 1 hour).
8. Punch down dough and divide into two sections. Knead both for several minutes.
9. Make the braids: cut each section of dough into 3 parts and roll between hands or on a board into long tapered cylinders.
10. Using the three ropes of dough, lay them side by side on a greased floured sheet. Braid them loosely from center to end. Repeat with the other three ropes of dough.
11. Finish the ends by tucking them under the dough.
12. Cover with a damp tea towel and let rise until almost doubled in bulk.
13. Brush tops with egg wash (1 egg yolk diluted with 1 to 2 tbsp of milk or water).
14. sprinkle with poppy seeds.
15. Bake for 15 minutes in the oven at 400 degrees.
16. Reduce oven heat to 375 and bake about 45 minutes longer.

** Content
:PROPERTIES:
:type: blurb
:END:
- This recipe was definitely more challenging (and nerve racking!) I had made pretzels before, but never braided three big braids of dough.
- I found the dough to be very wet in the process of kneading, so I frequently added a bit of flour to prevent sticking.
